...
//------------Lab-7-------------------------------------
  ...
  if(immediate == 1) {
    if(rw_flag == READING) {
      printf("Minix3 210010038_210010062: Reading from Immediate File.\n");
      ...
      printf("Minix3 210010038_210010062: File Contentsof Immediate File:\n");
      for(i = 0; i < f_size; ++i) {
        printf("%c", buffer[i]);
      }
      printf("Minix3 210010038_210010062: EOF - Immediate File\n");
      ...
      printf("Minix3 210010038_210010062: Writing to Immediate File.\n");
      vir_bytes zone;
